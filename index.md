> The open-source ``Python``-library ``manim`` allows for the creation of animations across various scientific fields. This frontpage includes some exemplary animations ranging from *Mathematics* over
